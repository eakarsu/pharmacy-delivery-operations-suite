...
PORT="${PORT:-5300}"
DB_NAME="${PGDATABASE:-pharmacy_delivery_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Pharmacy Delivery Operations Suite"
echo "======================================="
echo
...
echo "Starting pharmacy delivery operations suite frontend on http://localhost:$PORT"
echo "Login: admin@pharmacy-delivery-operations.local / admin123"
