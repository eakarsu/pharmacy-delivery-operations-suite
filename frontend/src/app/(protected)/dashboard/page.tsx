...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Pharmacy Delivery Operations Dashboard"
      subtitle="One merged pharmacy delivery operations view for Patients, Appointments, Cases, Care Plans, Authorizations, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared pharmacy delivery operations jobs into one surface. Patients, Appointments, Cases, Care Plans, Authorizations, Resources, documents, audit, and AI are presented as platform features.</div>
