export const AUTH_COOKIE = 'pharmacy_delivery_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@pharmacy-delivery-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@pharmacy-delivery-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@pharmacy-delivery-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
