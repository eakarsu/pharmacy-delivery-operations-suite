...
const adminCookie = await login('admin@pharmacy-delivery-operations.local', 'admin123');
const managerCookie = await login('manager@pharmacy-delivery-operations.local', 'manager123');
const analystCookie = await login('analyst@pharmacy-delivery-operations.local', 'analyst123');
